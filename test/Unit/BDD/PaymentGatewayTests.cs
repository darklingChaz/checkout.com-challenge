...
namespace Unit.BDD {
...

    {
        ...
        public async Task WithOutToken_CanNotSubmitPayment() {
            ...
            // When
            var response = await paymentGatewayHelper.ExecuteHttpRequest(HttpMethod.Post, PaymentGatewayHelper.AuthTokenUrl, paymentDetails);
        ...
        [Test]
        public async Task InvalidPaymentDetails() {
